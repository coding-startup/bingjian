...
window["_mstConfig"] = {
	appId:
		"YQ9rbRaV95zkufI_KckRrzMWpDrcXy03Y9CY9DcmsU4ZzO-VS-kL4ib8obnrxoCQJlCu46h4SMglk552TSup5hOyfQt8AXheAwiIv8azX9HDQjpplfL7vGtEV4GlXVlkQ",
	...
	imagePath:
		"http\x3a\x2f\x2fwww.microsofttranslator.com\x2fstatic\x2f26720725\x2fimg\x2f",
	debug: false,
	locale: "zh-chs",
	country: "",
	category: "",
...
Microsoft.Translator = new (function () {
	...
	c.serviceClient = l;
	if (window[K]) {
		for (var ic in c) if (!window[K][ic]) window[K][ic] = c[ic];
		c = window[K];
	} else window[K] = c;
	var Qb = (c.serviceClient.LoadScript = new (function () {
			...
			return function (f, i, a) {
				...
				if (
					(navigator.userAgent.indexOf("MSIE") > e && g > 2048) ||
					g > 8192
				)
					return j;
				...
				if (h) h.appendChild(d);
					...
					a.documentElement.insertBefore(
						d,
		...
		nc = new (function () {
			...
			return function (b) {
				...
				else if (typeof b.nodeType === I && c[b.nodeType])
					return c[b.nodeType];
				return typeof b;
			};
		})(),
		hc = new (function () {
			...
			function r(a) {
				...
				if (
					(f.length < h.length && b > 34) ||
					(c.escapeNonAscii && b > 122)
				)
					return f;
				else return h;
			}
			function h(a) {
				return a.toString().replace(f, r);
			}
			function n(a) {
				return '"' + h(a) + '"';
			}
		...
		z = new (function () {
			...
			return function (x, l, i, q, r) {
				...
				var b = [];
				for (var t in l) if (l[t] != j) b.push(t + "=" + hc(l[t]));
	...
	window["localizedLangs"] = mc;
	window["languageDirs"] = gc;
	window["languageMappings"] = jb;
	window["localizedOriginal"] = jc;
	var i = new (function () {
		var t = "100%",
			k = "0px",
			h = n,
		...
		var d = (b.getStyleValue = function (c, b) {
				...
				if (c.currentStyle)
					return !c.currentStyle[b] ? a : c.currentStyle[b];
				if (
			...
			M = (b.fixIEQuirks = function (a) {
				...
				if (g && g.indexOf(h) > e)
					a.style.width =
						parseInt(g) +
						parseInt(f + d(a, "borderLeftWidth")) +
						parseInt(f + d(a, "borderRightWidth")) +
						parseInt(f + d(a, "paddingLeft")) +
						parseInt(f + d(a, "paddingRight")) +
						h;
				var c = d(a, "height");
				if (c && c.indexOf(h) > e)
					a.style.height =
						parseInt(c) +
						parseInt(f + d(a, "borderTopWidth")) +
						parseInt(f + d(a, "borderBottomWidth")) +
						parseInt(f + d(a, "paddingTop")) +
						parseInt(f + d(a, "paddingBottom")) +
						h;
		...
		function B(a) {
			return (
				a.offsetLeft +
				(a.offsetParent && a.offsetParent.nodeType == 1
					? B(a.offsetParent)
					: 0)
			);
		}
		function C(a) {
			return (
				(a.parentNode && a.parentNode.nodeType == 1
					? C(a.parentNode)
					: 0) +
		...
		b.getVisibleWidth = function (b) {
			var a = r;
			if (window.innerWidth && window.innerWidth > a)
				a = window.innerWidth;
			else if (
		...
		var J = (b.getBlockParent = function (a) {
				var b = (a._display =
						a._display || i.getStyleValue(a, "display")),
			...
			y = (b.isInternetExplorer = function () {
				return (
					window.navigator.userAgent.toUpperCase().indexOf("MSIE") > e
				);
			});
		...
		function I(a, b, c, f) {
			...
			a._mstGradElem.style.marginBottom =
				"-" + a._mstGradElem.style.height;
	...
	function C(e, d, c) {
		...
		a.toString = function () {
			var c = "0" + this.r.toString(g),
				b = "0" + this.g.toString(g),
				a = "0" + this.b.toString(g);
			return (
				c.substr(c.length - 2) +
				b.substr(b.length - 2) +
				a.substr(a.length - 2)
	...
	C.parse = function (a) {
		...
		if (a.substr(0, 1) == "#") {
			if (a.length == 4)
				return new C(
					g * parseInt(a.substr(1, 1), g),
					g * parseInt(a.substr(2, 1), g),
					g * parseInt(a.substr(3, 1), g)
				);
			else if (a.length == 7)
				return new C(
					parseInt(a.substr(1, 2), g),
					parseInt(a.substr(3, 2), g),
					parseInt(a.substr(5, 2), g)
				);
	...
	(function (d) {
		...
		function Sb(n, e, d) {
			...
			e === void 0 && (e = "true"),
				(d === void 0 && (d = a),
				((x = Util.GetElement(pb)),
				((b = Util.GetElement(db)),
				((A = Util.GetElement(qb)),
				((J = Util.GetElement(rb)),
				((K = Util.GetElement(sb)), ((G = d == a), (i = d))))))));
			var f = document.createElement("link");
			f.setAttribute(P, window._mstConfig.floaterStylePath),
				f.setAttribute("rel", tb);
			var k = document.getElementsByTagName(D)[0];
			k.insertBefore(f, k.firstChild),
				((b.onmousedown = Ob),
				(x.setAttribute(h, j),
				(x.setAttribute(ub, vb), (A.setAttribute(h, j), (Z = n)))));
			var l = b.getElementsByTagName("input");
			for (var g = 0; g < l.length; g++) {
				var m = l[g];
				m.getAttribute("type").toLowerCase() == ab &&
					m.setAttribute("onclick", wb);
			}
			e.toLowerCase() == N && (S = !1),
				((T = !0),
				(window._bwmid ? (window._bwmid += xb) : (window._bwmid = yb),
				(Qb(
					zb,
					(document.location.protocol == "https:" ? Ab : Bb) + Cb
				),
				!O && S && (c.serviceClient.Community.forceLoad(), (O = !0)))));
		}
		function V() {
			b.style.display = m;
		}
			...
			var e = setInterval(function () {
				if (window.LanguageMenu) {
					...
					try {
						...
						(g = Util.GetElement(eb)),
							i == a
								? (g.parentNode.style.display = q)
								: ((g.parentNode.style.display = m),
								  G
										? (g.innerHTML = window._mstConfig.autoDetected.replace(
												r,
												p[i]
										  ))
										: (g.innerHTML = p[i]));
		...
		function t() {
			(x.style.display = q),
				((J.style.display = q),
				((A.style.display = q), ((z = !1), clearTimeout(l))));
		}
		function v(a, c) {
		...
		function bb(e) {
			...
			if (d && window.LanguageMenu && window.LanguageMenu.getValue) {
				...
				(c = c.replace(
					r,
					encodeURIComponent(
						j + q + H + window.LanguageMenu.getValue()
					)
				)),
					((c = c.replace(Q, encodeURIComponent(j))),
					(Util.GetElement(Gb).setAttribute(P, Hb + b + "&body=" + c),
					(Util.GetElement(Ib).setAttribute(
						"title",
						Util.GetElement(Jb).getAttribute(h).replace(r, f)
					),
		...
		function jb() {
			...
			location.search.length == 0
				? Util.GetElement(c).setAttribute(h, b + Lb + f)
				: location.search.indexOf("__mstto") != e
				? b.match(/__mstto=(.+)([&]+)/i)
					? Util.GetElement(c).setAttribute(
							h,
							b.replace(/__mstto=(.+)([&&]+)/i, H + f + s)
					  )
					: b.match(/__mstto=(.+)/i) &&
					  Util.GetElement(c).setAttribute(
							h,
							b.replace(/__mstto=(.+)/i, H + f)
					  )
				: Util.GetElement(c).setAttribute(h, b + Mb + f),
				(J.style.display = m);
		}
		function kb() {
			t();
		...
		function Nb() {
			f.toLowerCase() != window[Zb].getValue().toLowerCase() &&
				(clearTimeout(l),
				((f = window.LanguageMenu.getValue()),
		...
		function Ob(a) {
			return (
				...
				((L = a.clientX),
				((F = a.clientY),
				((document.onmousemove = Pb),
				((document.onmouseup = Rb),
				(document.body.focus(),
		...
		function Pb(a) {
			...
			var c = Util.getPosition(b),
				...
				e = a.clientY - F;
			return (
				v(parseInt(c.left) + d, parseInt(c.top) + e),
				((L = a.clientX), ((F = a.clientY), !1))
			);
		}
		function Rb(a) {
			return (
				...
				((b.ondragstart = o), (Util.removeClass(b, W), !1))))
			);
		}
		var p = {},
			Z,
		...
		(d.Initialize = Sb),
			((d.Show = C),
			((d.TranslationComplete = X),
			((d.TranslationProgress = bb),
			((d.TranslationError = cb),
			((d.OnClose = fb),
			((d.OnShareBackClick = gb),
			((d.OnMouseOverFloater = hb),
			((d.OnMouseOutFloater = ib),
			((d.ShowSharePanel = jb), (d.ShowEmbed = kb))))))))));
	})(w || (w = {})),
		((l.FloaterInitialize = function (a, b, c) {
			w.Initialize(a, b, c);
		}),
	...
	var pc = (function () {
		...
		return (
			...
			((b.prototype.TranslateElement = function (
				o,
				h,
				e,
				j,
				...
				e === void 0 && (e = document.documentElement),
					(b === void 0 && (b = !0),
					(a.validate(o, "from", !1, f), a.validate(h, "to", !0, f)));
				if (!a.isElement(e) && !a.isNode(e))
					throw new Error("Invalid DomElement");
				a.validate(j, "onProgress", !1, c),
					(a.validate(k, "onError", !1, c),
					(a.validate(l, i, !1, c),
					(a.validate(m, "onRestoreOriginal", !1, c),
					(a.validate(p, "timeOut", !1, g, !0),
			...
			((b.prototype.GetLanguagesForTranslateLocalized = function () {
				...
				if (!a.langLocalized) {
					...
					for (var b in window.localizedLangs)
						a.langLocalized[a.langLocalized.length] = new oc(
			...
			((b.prototype.SetUpdatedAccessToken = function (c) {
				...
				if (d && d.length > 0)
					for (var g = 0; g < d.length; g++) {
						...
						if (
							h &&
							(h.toLowerCase().indexOf("roledashboard.aspx") !=
								e ||
								h.toLowerCase().indexOf("bulkdashboard.aspx") !=
									e)
						) {
							var k = "https://" + i[2],
								k = k.replace("www.", "ssl.");
				...
				var m = window._mstConfig.onErrorHandlerName
					? Nb + window._mstConfig.onErrorHandlerName
					: a;
				f.src =
					(location &&
					location.href &&
					...
					m;
				var l =
					document.getElementsByTagName(D)[0] ||
					document.documentElement;
	...
	var lc = new (function () {
			...
			return function (s, L, u, P, z, w) {
				...
				var x = e,
					...
					Q = (v.hover = function (d) {
						...
						if (z.showHighlight) {
							...
							try {
								a =
									"#" +
									C.parse(s.style.backgroundColor).toString();
							} catch (c) {}
						...
						if (
							...
							w &&
							w[s._mstHash] &&
							w[s._mstHash]._mstTooltip
						)
							w[s._mstHash]._mstTooltip.hover();
					}),
					bb = (v.unhover = function (a) {
						...
						if (
							...
							w[s._mstHash]._mstTooltip.unhover();
					});
				function Z() {
					if (h) return;
					if (x) kb();
				...
				var kb = (v.show = function () {
					...
					if (!o._mstTooltip) {
						...
						o._mstTooltip.style.fontFamily =
					...
					var h,
						fb =
							i.getStyleValue(s, cb) == C ||
							i.getStyleValue(s, "text-align") == ab;
					if (fb)
						h =
							i.absXPos(s) +
							s.offsetWidth -
							o._mstTooltip.offsetWidth;
					else h = i.absXPos(s);
					if (
						h + o._mstTooltip.offsetWidth >
						i.absXPos(u) + u.offsetWidth
					)
						h =
							i.absXPos(u) +
							u.offsetWidth -
							o._mstTooltip.offsetWidth;
					if (h < i.absXPos(u) && i.absXPos(u) + m < kb)
						h = i.absXPos(u);
					if (i.getStyleValue(s, cb) != C) {
						if (h + o._mstTooltip.offsetWidth > O + S - 8)
							h = O + S - 8 - o._mstTooltip.offsetWidth;
						if (h < S + 8) h = S + 8;
					}
					o._mstTooltip.style.left = h + n;
					o._mstTooltip.style.top =
						Math.max(
							i.absYPos(s) - (o._mstTooltip.offsetHeight + 8),
							8
						) + n;
				});
				function Y() {
				...
				var R = (v.hide = function () {
					...
					mb = (v.detach = function () {
						...
						i.removeEvent(
							s,
							s,
							window.navigator.msPointerEnabled ? W : X,
							db
						);
					}),
					eb = i.addEvent(s, S, Q),
		...
		sc = new (function (K) {
			...
			window._mstCmCb = function () {
				...
				if (pb) pb.onclick = mb;
				if (i.isInternetExplorer() && i.isQuirksMode(document))
					i.fixIEQuirks(f);
				fb.onclick = function () {
					sb(-3);
					return d;
				...
				if (kb >= 5)
					window.Microsoft.TranslatorOverride.showHighlight = Vb;
			};
			var Yb = (z.showTooltip = function (a, b, c) {
					if (!f || f.ownerDocument != c.ownerDocument) return;
					m = a._mstTooltip;
					Hb = a.getAttribute(O);
					Bb = b.getAttribute(O);
					wb = a;
			...
			function Pb(b) {
				...
				var u =
					...
					o =
						b.Translations.length > 0 &&
						b.Translations[0].Rating >= 5,
				...
				var j = e,
					n = e;
				for (var g = 0; g < b.Translations.length; ++g) {
					if (j == e && b.Translations[g].Rating < 5) j = g;
					if (j != e && b.Translations[g].Rating > -5) n = g;
				}
				if (j >= 0 && n > j)
					for (var g = j; g < n; ++g)
						for (var m = g + 1; m <= n; ++m)
							if (
								b.Translations[g].Count <
								b.Translations[m].Count
							) {
				...
				if (
					...
					(document._mstTooltip.style.display == h ||
						f.style.display == h)
				)
					vb();
				return k.slice(0);
			...
			function Sb(a, y, A, z) {
				var s = "4px 1px 0px 3px",
					r = "4px 3px 0px 1px",
					q = gb,
					e = (this.panel = document.createElement(u));
				e.className = Ib;
				y.appendChild(e);
				a.OriginalText = wb._mstNormalize();
				var v = Fb._mstDenormalize(a.TranslatedText),
					l = document.createElement(u);
				l.className = "MSTCTransBox";
				if (z) l.style.color = "#006622";
				l.appendChild(
					document.createTextNode(v.innerText || v.textContent)
				);
				e.appendChild(l);
			...
			var vb = (z.hideTooltip = function () {
				...
				Eb = (z.showDashboard = function () {
					...
					b.style.borderRight = b.style.borderBottom =
						"solid 1px black";
					...
					setTimeout(function () {
						...
						if (!i.isInternetExplorer())
							a.style.left =
								(b.offsetWidth - a.offsetWidth).toString() + bb;
			...
			function qb(a, f, g) {
				...
				for (
					var d = q;
					d < a.transItems.length && e < lb && d - q < 10;
					++d
				) {
						...
						for (var c = 0; c < d.length; ++c)
							if (d[c].Translations.length > 1)
								if (d[c].Translations[0].Rating > 5)
									a.transItems[
										q + c
									].tgt.style.backgroundColor = "#E6E6E6";
			...
			new (function () {
				...
				if (b && (b[1].toLowerCase() == N || b[1].toLowerCase() == J))
					Cb = d;
				if (e) {
					Db = {};
					var j = e.split(",");
					for (var g = 0; g < j.length; ++g)
						Db[j[g].toLowerCase()] = 1;
				}
				if (I)
					Q = function () {
	...
	(function (g) {
				...
				if (window[f]) {
					...
					try {
						...
						if (q == a) l.parentNode[V].display = x;
							...
							if (M)
								l.innerHTML = window[W].autoDetected.replace(
									y,
									w[q]
								);
		...
		function Rb(g) {
			...
			if (e && window[f] && window[f].getValue) {
				...
				d = d.replace(
					y,
					encodeURIComponent(i + j + X + window[f].getValue())
				);
				d = d.replace(Q, encodeURIComponent(i));
				Util.GetElement(Gb).setAttribute(P, Hb + c + "&body=" + d);
				Util.GetElement(Ib).setAttribute(
					"title",
					Util.GetElement(Jb).getAttribute(m).replace(y, h)
				);
		...
		function Yb() {
			...
			if (location.search.length == 0)
				Util.GetElement(c).setAttribute(m, b + Lb + h);
			else if (location.search.indexOf("__mstto") != e) {
				if (b.match(/__mstto=(.+)([&]+)/i))
					Util.GetElement(c).setAttribute(
						m,
						b.replace(/__mstto=(.+)([&&]+)/i, X + h + s)
					);
				else if (b.match(/__mstto=(.+)/i))
					Util.GetElement(c).setAttribute(
						m,
						b.replace(/__mstto=(.+)/i, X + h)
					);
...
function CUtil() {
	...
	a.AbsXPos = function (a) {
		return (
			a.offsetLeft +
			(a.offsetParent != b ? this.AbsXPos(a.offsetParent) : 0)
		);
	};
	a.AbsYPos = function (a) {
		return (
			a.offsetTop +
			(a.offsetParent != b ? this.AbsYPos(a.offsetParent) : 0)
		);
	};
	...
	a.GetStyleValue = function (e, c) {
		...
		if (a.currentStyle)
			d =
				a.currentStyle[c] ||
				a.currentStyle.getAttribute(c.replace("-"));
...
MtPopUpList.prototype = {
	...
	Init: function (d, c, i, g, h) {
		...
		a.cropText();
		if (a.elemPopup != null) {
			a.elemPopup.onkeydown = new a.doKeyDown(
				a,
				a.HideCurrentPopup
			).execute;
				...
				setTimeout(function () {
					...
					for (var b = 0; b < c.length; b++) {
						...
						if (
							...
							f !=
								(a.getActiveLink().outerText ||
									a.getActiveLink().text)
						) {
							d = c[b];
							break;
						}
...
window["_mstConfig"].floaterStylePath =
	"http://www.microsofttranslator.com/static/26720725/css/WidgetV3.css?v=26720725";
